...
- [x] 16. EngineRegistry + capability probe framework
...
- [x] 17. V8EngineAdapter: six analysis types end-to-end
...
- [x] 18. V8 bytecode/deopt parsers + golden fixtures
...
- [x] 20. SelectionService wrapping strategies (safe standalone snippets)
...
- [x] 28. Runtime/engine pairing UX + disk management
...
- [x] 29. Benchmark command (selection microbenchmarks)
...
- [x] 30. Inspector plumbing PoC (--inspect websocket attach)
...
- [x] 31. Packaging: NSIS installer + updater scaffold + single-instance
...
- [x] 32. Docs pack: threat model, licensing, Windows troubleshooting, custom-builds, README
